...
**Plan day:** Day 63 (Wed 18 Nov) · **Status:** `not-started`
...
- [ ] Schema validation vs business validation: give an example of each here.
- [ ] When do you stop retrying and flag for human review?
