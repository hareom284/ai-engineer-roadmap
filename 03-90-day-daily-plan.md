...
**Day 2 (Tue)** — Type hints, Pydantic v2
...
**Day 6 (Sat, 3–4h)** — Postgres + SQLAlchemy/SQLModel + Alembic
...
**Day 10 (Wed)** — Tool calling / structured output
...
**Day 14 (Sun, 3h)** — Prompting patterns + LeetCode
...
**Day 16 (Tue)** — Code-aware chunking
...
**Day 19 (Fri)** — End-to-end answer with citations
...
**Day 21 (Sun, 3h)** — Framework comparison + LeetCode
...
**Day 24 (Wed)** — LLM-as-judge + refusal test
...
**Day 27 (Sat, 4h)** — Tuning round 2 + hardening
...
**Day 30 (Tue)** — Blog post draft + LinkedIn
...
**Day 34 (Sat, 4h)** — 3-tool agent + tracing
...
**Day 35 (Sun, 3h)** — Human-in-the-loop + LeetCode
...
**Day 42 (Sun, 3h)** — Run all 40 + LeetCode
...
**Day 44 (Tue)** — Prompt injection defenses
...
**Day 63 (Wed)** — Validation + retry loop
...
**Day 67 (Sun, 3h)** — Dashboard + LeetCode
...
**Day 73 (Sat, 4h)** — README + diagram + video
- README with accuracy table, infra diagram, cost table, limitations, "what failed". 90-second video.
- Commit: `docs: README v1`

**Day 74 (Sun, 3h)** — Blog post #3 + LeetCode
- "Invoice extraction with LLMs: measuring field-level accuracy across two models." Publish + LinkedIn.

**Day 75 (Mon)** — Redeploy Projects 1 & 2 to AWS (optional) or add AWS section to their READMEs; make sure all three live URLs work first-click.
...
**Day 77 (Wed)** — Resume: AI Engineer version
...
**Day 78 (Thu)** — Resume: Full-Stack (AI) version + ATS check
...
**Day 81 (Sun, 3h)** — Interview prep: system design
...
**Day 84 (Wed)** — Applications batch 1
